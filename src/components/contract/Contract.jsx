...
import {CurrencySymbol, LIST_KEY, ZeroAddress} from '/src/enums/DeroContractConstants.js';
...
import {FlexBoxRow} from "@/components/common/styles/FlexBoxRow.jsx";
import {BackupContractList} from "@/components/BackupContractList.jsx";
    ...
    <>
      {hasData ?
        <div className='container mx-auto pb-20'>
          <div className='flex justify-between ml-8 text-md'>
            <>
              {
                scid.length ?
                  <div>
              ...
              { storedData
                ? <div className='mr-8'><span><BackupContractList /></span></div>
                : ''
              }
            </>
          </div>
